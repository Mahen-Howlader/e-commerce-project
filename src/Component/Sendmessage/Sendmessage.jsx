            ...
            <div className=" w-full relative dark:bg-gray-800">
                <div className="relative bottom-0 isolate overflow-hidden px-6 py-24 sm:px-24 xl:py-32">
                    ...
                    <form className="mx-auto mt-10 flex max-w-md gap-x-4">
                        <label htmlFor="email-address" className="sr-only">Your Email address</label>
                        <input
                            id="email-address"
                            name="email"
                            type="email"
                        ...
                        <button
                            type="submit"
                            className="flex-none border border-primary-200/50 dark:border-none rounded-md dark:bg-white dark:text-gray-900 bg-gray-100 text-gray-900 px-3.5 py-2.5 text-sm font-semibold shadow-sm hover:bg-gray-100 dark:hover:bg-gray-100"
                        >
                            Subscribe
                        </button>
                    </form>
